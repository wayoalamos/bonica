...
class PromotionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post promotions_url, params: { promotion: { body: @promotion.body, title: @promotion.title } }
    end
  ...
  test "should update promotion" do
    patch promotion_url(@promotion), params: { promotion: { body: @promotion.body, title: @promotion.title } }
